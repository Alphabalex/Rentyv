...
return [
    ...
    'forgot_password'       => [
        ...
        'message' => '<p>Have you forgotten your password?</p><p>Please enter your email account. System will send an email with active link to reset your password.</p>',
        'submit'  => 'Submit',
    ],
    'reset'                 => [
        ...
        'fail'                  => 'Token is invalid, the reset password link has expired!',
        'reset'                 => [
            'title' => 'Email reset password',
        ],
        'send'                  => [
            'success' => 'An email was sent to your email account. Please check and complete this action.',
            'fail'    => 'Can not send email at this time. Please try again later.',
        ],
