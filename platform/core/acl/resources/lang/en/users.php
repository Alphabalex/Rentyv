...
return [
    ...
    'save_setting_failed'        => 'Something went wrong when saving your setting',
    'not_found'                  => 'User not found',
    'email_exist'                => 'That email address already belongs to an existing account',
    'username_exist'             => 'That username already belongs to an existing account',
    ...
    'error_update_profile_image' => 'Error when updating profile image',
    'email_reminder_template'    => '<h3>Hello :name</h3><p>The system has received a request to reset the password for your account, to complete this task please click the link below.</p><p><a href=":link">Reset password now</a></p><p>If you did not ask to reset your password, please ignore this email.</p><p>This email is valid for 60 minutes after receiving the email.</p>',
