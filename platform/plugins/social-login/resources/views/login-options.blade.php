    ...
    <div class="login-options">
        ...
        <ul class="social-icons">
            @if (setting('social_login_facebook_enable', false))
                <li>
                    <a class="social-icon-color facebook" data-bs-original-title="facebook"
                       href="{{ route('auth.social', 'facebook') }}"></a>
                </li>
            @endif
            @if (setting('social_login_google_enable', false))
                <li>
                    <a class="social-icon-color googleplus" data-bs-original-title="Google Plus"
                       href="{{ route('auth.social', 'google') }}"></a>
                </li>
            @endif
            @if (setting('social_login_github_enable', false))
                <li>
                    <a class="social-icon-color github" data-bs-original-title="Github"
                       href="{{ route('auth.social', 'github') }}"></a>
                </li>
            @endif
            @if (setting('social_login_linkedin_enable', false))
                <li>
                    <a class="social-icon-color linkedin" data-bs-original-title="linkedin"
